...
public class EmbeddedMysqlConfig {
    public EmbeddedMysqlConfig() {
        ...
        MysqldConfig mysqldConfig = MysqldConfig.aMysqldConfig(Version.v8_latest)
                .withCharset(UTF8)
                .withPort(System.getenv("MYSQL_PORT") != null ? Integer.parseInt(System.getenv("MYSQL_PORT")) : 3306)
        ...
        EmbeddedMysql embeddedMysql = EmbeddedMysql.anEmbeddedMysql(mysqldConfig)
                .addSchema(System.getenv("MYSQL_DATABASE"),
        ...
        System.setProperty(
                ...
                "jdbc:mysql://"
                        ...
                        + "?serverTimezone=UTC&useSSL=false&allowPublicKeyRetrieval=true"); // MySQL URL 설정
        System.setProperty("spring.datasource.username", System.getenv("MYSQL_USER")); // MySQL 사용자 설정
        System.setProperty("spring.datasource.password", System.getenv("MYSQL_PASSWORD")); // MySQL 비밀번호 설정
    }
}
